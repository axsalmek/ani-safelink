...
var xxx=null;
if(x=="1"){xxx="/2020/01/keuntungan-menggunakan-agen-branding.html"}
if(x=="2"){xxx="/2020/01/cara-menghasilkan-prospek-dengan-hadiah.html"}
if(x=="3"){xxx="/2020/01/efek-kanker-payudara-sistem-dan-area.html"}
if(x=="4"){xxx="/2020/01/panduan-sederhana-untuk-memaksimalkan.html"}
a_to_ve[i].href="https://www.animebatch.eu.org/"+xxx+"?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
